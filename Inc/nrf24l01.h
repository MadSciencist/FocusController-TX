...
#define NRF24L01_CSN_PORT			SPI_CSN_GPIO_Port
#define NRF24L01_CSN_PIN			SPI_CSN_Pin
#endif
...
#define NRF24L01_CSN_LOW           HAL_GPIO_WritePin(SPI_CSN_GPIO_Port, SPI_CSN_Pin, GPIO_PIN_RESET)
#define NRF24L01_CSN_HIGH          HAL_GPIO_WritePin(SPI_CSN_GPIO_Port, SPI_CSN_Pin, GPIO_PIN_SET)
    /*
